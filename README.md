...
<h2 align="center">프로젝트 설명 영상 및 발표자료</h2>
...
<table>
	<tr>
		...
		<td>
			<a href="https://docs.google.com/presentation/d/e/2PACX-1vQ43KBXZZqnEAMP_ddxZRnNsgHBSEi2qVnJPBkTqsEBGGmw-ERHwm6VLj499oOF5rKSbOB6h0kazxMD/pub?start=false&loop=false&delayms=3000"><img src="images/ppt.gif" alt="발표 자료"></a>
		</td>
	</tr>
	<tr>
		<td align="center">
...
<table>
  ...
  <tr>
    ...
    <td>o 개요: 사용자 인증을 위한 로그인 화면입니다. 아이디와 비밀번호를 입력하고 허가된 사용자만 app에 접속할 수 있습니다. <br><br>
...
<br>
 ...
 <table>
  ...
  <tr>
    ...
    <td>o 개요: 사용자 신청을 위한 회원가입 화면입니다. 아이디, 이름, 이메일, 소속부대, 비밀번호, 권한을 등록합니다.<br><br>
	o 엑터명: 탑승자, 수송업무 담당자, 운전자<br><br>
...
<table>
  ...
  <tr>
    ...
    <td>o 개요: 군 이동수단(차량) 관련 실시간 배차신청 화면입니다. 출발지 목적지를 설정할 수 있으며, 탑승인원 그리고 차량 이용시간 등 세부사항을 설정할 수 있습니다.<br><br>
	o 엑터명: 탑승자<br><br>
	o 사전 조건: 회원 가입이 되어있어야 함.<br>
	o 사후 조건: -<br><br>
	o 기능 흐름:<br>
	   1. 사용자는 출발지와 도착지를 설정합니다.<br>
	   2. 탑승인원 탭에서 탑승자 인원수를 설정합니다.<br>
	   3. 출발일자, 도착일자 탭에서 차량 이용시간을 설정합니다.<br>
	   4. 배차 가능 차량 검색 버튼을 통해 실시간으로 예약/사용 가능한 차량을 검색합니다.</td>
  </tr>
</table>
<br>
...
<table>
  ...
  <tr>
    ...
    <td>o 개요: 1-1. 배차 신청 화면에서 설정한 출발지 및 도착지, 탑승인원,차량 이용시간 등에 따라 선택할 수 있는 차량 목록이 리스트 형태로 도시됩니다. 차량의 외관 사진, 차량 번호, 색상 등에 대한 정보를 볼 수 있으며, 선택하기 버튼을 누르면 실시간으로 배차 신청을 할 수 있습니다.<br><br>
	o 엑터명: 탑승자<br><br>
	...
	o 기능 흐름:<br>
	   ...
	   3. 2-3. 배차 확인 화면에서 선택한 차량의 배차 진행 현황을 확인할 수 있습니다.</td>
  </tr>
</table>
<br>
...
<table>
  ...
  <tr>
    ...
    <td>o 개요: 배차 확인 화면에서는 탑승자가 신청한 차량에 대한 예약 진행 현황을 확인할 수 있습니다. 상태는 '배차진행중', '배차불가', '배차확정'으로 나뉘며, 탑승자는 배차 취소 및 해당 차량 상세보기 메뉴를 사용할 수 있습니다.<br><br>
	o 엑터명: 탑승자<br><br>
...
<table>
  ...
  <tr>
    ...
    <td>o 개요: 군 이동수단의 관리 화면입니다. 안전 점검표를 차량 운행 전에 작성하고, 운행계획을 작성할 수 있습니다. 또한 사고접수, 구난차량 요청, 응급환자 후송 요청 등 응급상황에 대처할 수 있는 기능들을 포함하고 있습니다. 또한 차량 이용 완료 후에는 반납까지 one-stop으로 차량 관리 서비스를 받을 수 있습니다.<br><br>
	o 엑터명: 탑승자<br><br>
...
<table>
  ...
  <tr>
    ...
    <td>o 개요: 군 이동수단(차량)의 운행간 운행경로, 운행시간, 운행거리(KM)를 기록할 수 있는 화면입니다. 운행 시작 버튼을 클릭하면 주행 기록이 시작되고, 종료 버튼을 클릭하면 주행 기록이 종료됩니다..<br><br>
	o 엑터명: 운행자<br><br>
	o 사전 조건: 배차 승인이 되어있어야 함.<br>
	o 기능 흐름:<br>
	   1. 사용자는 배차된 차량의 상세정보 페이지에서 플로팅 버튼 메뉴 중 운행 메뉴를 선택합니다.<br>
	   2. 출발지를 중심으로 지도가 도시되며, 운행 시작 버튼을 클릭하면 기록이 시작됩니다.<br>
	   3. 주행을 완료한 이후 운행 중지 버튼을 클릭하면 기록이 저장됩니다.<br>
	   4. 4-2. 운행이력 조회 화면에서 저장한 주행 기록을 확인할 수 있습니다.</td>
  </tr>
</table>
<br>
...
<table>
  ...
  <tr>
    ...
    <td>o 개요: 운행이력 조회 화면입니다. 4-1. 주행 기록 화면에서 저장한 기록들을 리스트 형태로 열람할 수 있으며, 총 누적 km 수를 확인할 수 있습니다.<br><br>
	o 엑터명: 운행자<br><br>
	o 사전 조건: 운행 기록이 완료되어야 함.<br>
	o 사후 조건: -<br><br>
	o 기능 흐름:<br>
	   1. 사용자는 운행이력 조회 탭을 클릭하여 누적된 운행이력들을 조회합니다.<br>
	   2. 운행이력의 각 항목에서 출발지, 목적지, 운행시간, 운행km를 확인합니다.<br>
	   3. 화면 우측 상단에서 총 누적 km 운행거리를 확인 및 활용합니다.</td>
  </tr>
</table>
<br>
 ...
 <table>
	...
	<tr>
		<td align="center" width="50%"><img src="images/example-3.gif" alt="관리자 페이지"></td>
		<td>o 개요: 수송업무 담당자가 접속하여 사용자, 차량, 이력 등을 관리할 수 있는 페이지입니다. 차량들을 등록하고 관리할 수 있으며, 배차를 승인하고 반려할 수 있습니다.<br><br>
			o 엑터명: 수송업무 담당자<br><br>
			o 사전 조건: 시스템 관리자 권한 및 계정/비밀번호 부여.<br>
			o 사후 조건: -<br><br>
			o 기능 흐름:<br>
			1. 관리자는 회원가입을 요청한 사용자에 대해서 승인/반려 처리합니다.<br>
			2. 배차 예약 현황을 확인하고 배차가 가능할 경우 승인하고, 불가할 경우 반려합니다.<br>
			3. 사고접수, 구난차량 요청 현황을 확인하고 즉각적으로 서비스를 제공합니다.<br>
			4. 관리자는 이동수단(차량)의 현황을 조회하고 등록/수정/삭제합니다.</td>
	<tr/>
		

 #### 5-2. 전체 이동현황 조회
<div align="center">
    <img src="images/example-4.gif" alt="전체 이동현황 조회">
</div>
<br>
o 기능명: 전체 이동현황 조회 <br><br>
o 개요: 수송업무 담당자가 접속하여 실시간으로 배차된 차량들의 이동 현황을 확인하고, 상세 내용을 조회할 수 있습니다.<br><br>
o 엑터명: 수송업무 담당자<br><br>
o 사전 조건: 시스템 관리자 권한 및 계정/비밀번호 부여.<br>
o 사후 조건: -<br><br>
o 기능 흐름:<br>
1. 관리자는 전체 이동현황 조회화면에 접속하여 실시간으로 배차된 차량들의 이동 현황을 확인합니다.<br>
2. 간선을 클릭하여 해당 간선의 상세정보(차량정보,출발지/목적지) 등을 확인합니다.<br>
3. 운행의 이상 현상을 식별(ex.지속적인 정차/경로 이탈)하여 사고를 조기에 탐지합니다.<br>
4. 시각적으로 전반적인 차량의 운행 흐름을 파악하고 통계 자료로 .</td>
